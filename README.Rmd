...
-----------------
  ...
  * ROpensci are developing a related package - [tic](https://github.com/ropenscilabs/tic.package).
  The [tic](https://github.com/ropenscilabs/tic.package) package aims to specify the CI environment purely by an R script.
