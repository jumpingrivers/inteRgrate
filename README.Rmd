 ...
 * `check_meta()` - ensure that the DESCRIPTION file is tidy, 
 via `usethis::use_tidy_description()`, checks README.Rmd timestamps, checks .gitignore
 contains standard files.
